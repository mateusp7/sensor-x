...
export const TextArea = ({
  ...
  return (
    <div className="flex flex-col gap-1 mb-2">
      <textarea
        className={`border-2 resize-none font-medium placeholder:text-base text-neutral-7 rounded-lg bg-transparent outline-none w-full h-36 p-4 md:p-6 transition-colors duration-100 ease-linear ${
          props.error
